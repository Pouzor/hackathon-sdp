...
export const ASTRONAUTS: Astronaut[] = [
  ...
  },
  {
    ...
    hobbies: "Danse, Manga",
    client: "Decathlon",
    contributions: [{ id: 1, activity: "Workshop animé", points: 60, date: "2026-04-05" }],
    trophies: [],
  },
  {
    id: 12,
